    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <table class="table table-condensed">
                ...
                <tbody>
                    <?php if($query = $koneksi->query("SELECT * FROM `order` o LEFT JOIN order_detail d ON o.id_order=d.id_order LEFT JOIN pelanggan p ON o.id_pelanggan=p.id_pelanggan WHERE o.status_kirim='belum' GROUP BY o.id_order")): ?>
                        <?php $no = 1; ?>
